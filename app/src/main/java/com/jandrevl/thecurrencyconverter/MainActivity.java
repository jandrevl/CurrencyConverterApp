...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> baseCurrenciesArrayAdapter = ArrayAdapter.createFromResource(this, R.array.baseCurrencies, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<CharSequence> currenciesArrayAdapter = ArrayAdapter.createFromResource(this, R.array.currencies, android.R.layout.simple_spinner_item);
        ...
        baseCurrenciesSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                baseCurrency = getResources().getStringArray(R.array.baseCurrencies)[i];
